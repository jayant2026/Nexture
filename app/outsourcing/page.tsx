...
const OutsourcingPage = () => {
  ...
  const clientLogos = [
    ...
    { name: "Bank Trust", src: "https://via.placeholder.com/150x50?text=BankTrust" },
    { name: "Shop Online", src: "https://via.placeholder.com/150x50?text=ShopOnline" },
    { name: "Game World", src: "https://via.placeholder.com/150x50?text=GameWorld" },
    { name: "Consumer Products", src: "https://via.placeholder.com/150x50?text=ConsumerProducts" }
  ];
